...
cap.set(3,wcam)
cap.set(4,hcam)
#Checks folder for images to display
...
#stores the id of the finger in tips and runs a loop while checking the same
tipIds=[4,8,12,16,20]
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        print(handsType)    
    #finds hand type and shows the image if finger is displayed
    fingersL=[]
    fingersR=[]
    if results.multi_hand_landmarks != None:
        for i in handsType:
